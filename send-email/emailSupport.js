...
// the event title as the subject, and will contain a link to the
// event in DayBack. You will likely need to modify this code to
// reflect the exact format of the email
//
