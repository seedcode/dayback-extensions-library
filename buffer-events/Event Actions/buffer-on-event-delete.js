// Buffer Events - On Event Delete v1.0

// Name: Buffer Events - On Event Delete
// Type: Event Action
// Trigger: On Event Delete
// Prevent Default Action: No

// Purpose:
// When an event is deleted, remove any buffer events associated with it
// from the client-side calendar display.
...
(() => {
	...
	function run() {
		const bufferFieldMap = seedcodeCalendar.get('buffers-bufferFieldsMap');
