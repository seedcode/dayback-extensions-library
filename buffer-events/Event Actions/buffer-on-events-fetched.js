// Buffer Events - On Events Fetched v1.0

// Name: Buffer Events - On Events Fetched
// Type: Event Action
// Trigger: On Events Fetched
// Prevent Default Action: No

// Purpose:
// When events are fetched, build and insert buffer events for parent events
// that have buffer time configured.
...
(() => {
	...
	function run() {
		//
		let eventsArray = params.data.events;
