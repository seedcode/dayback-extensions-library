...
try {
    ...
    //      };
    //
    // Each taggroup contains three parameters
    //
    //      groupname:
    //
...
function run() {
    ...
    function injectTagFilters(container) {
        ...
        var filterText = filterBox ? filterBox.value : "";
        ...
        for (let i = 0; i < customSelects.length; i++) {
            ...
            // to detect when mouse mouse outs of context
        ...
        // Function toggles a filters on an of in response to contents of filter box query
        function toggleFilter(tag, ignoreFlag = 0) {
