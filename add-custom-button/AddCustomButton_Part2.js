...
function run() {
	...
	var buttonContainer = document.getElementById(
		options.cssGroupName + '_containerId'
	);
	...
	function toggleButtonsWithAnalytics() {
		var toggleClass = buttonContainer.classList.contains(
			options.cssGroupName + '_container_static'
		)
			? options.cssGroupName + '_container_no_analytics_static'
			: options.cssGroupName + '_container_no_analytics';
