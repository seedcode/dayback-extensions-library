// Drag to Sort Unscheduled Events v1.0 - Part 4 of 5

// Name: Drag to Sort Unscheduled Events - Part 4
// Type: Event Action
//
// Purpose:
...
function run() {
    ...
    if (event.unscheduled && ddmo) {
        ...
        const newEventsOnTop = ddmo.get('newEventsOnTop');
        const fieldName = ddmo.get('sequenceFieldName');
